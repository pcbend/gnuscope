...
void PgamSortSelectionWindow() {
  ...
  gtk_box_pack_start(GTK_BOX(localmainbox), localhbox, FALSE, FALSE, 0);

  /* --- make a button for sorting raw singles --- */

  localbutton = gtk_button_new_with_label("Sort Raw Singles");
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(RawSinglesSort), NULL);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(CloseWidgetPgamSort),
  ...
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PgamSortCallback), NULL);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(CloseWidgetPgamSort),
                   GTK_OBJECT(localwindow));
  gtk_container_add(GTK_CONTAINER(localmainbox), localbutton);
  ...
  g_signal_connect_swapped(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(CloseWidgetPgamSort),
                           GTK_OBJECT(localwindow));
  gtk_container_add(GTK_CONTAINER(localmainbox), localbutton);
  ...
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(TACGateToggle), NULL);
  localbutton = gtk_check_button_new_with_label("2D (bannana) Gate");
  gtk_container_add(GTK_CONTAINER(localvbox), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PartGateToggle), NULL);
  ...
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PartEnGateToggle), NULL);
  ...
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(GammaGateToggle), NULL);
  ...
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PgamSortGateGammaTypeEntry),
                   NULL);
  ...
  localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PgamSortGateGammaTypeFile), NULL);
  ...
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PgamSortBrowse4), NULL);
  locallabel = gtk_label_new("     ");
  gtk_container_add(GTK_CONTAINER(localhbox2), locallabel);
  ...
  gtk_container_add(GTK_CONTAINER(localvbox), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(CloverSelfSuppressToggle), NULL);
  ...
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(CloverMinMultipolarityToggle),
                   NULL);
  ...
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PgamGateVetoToggle), NULL);
  pgamentry14 = gtk_entry_new();
  gtk_container_add(GTK_CONTAINER(localhbox2), pgamentry14);
  localbutton = gtk_button_new_with_label("Browse");
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PgamSortBrowse14), NULL);
  ...
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PgamGateRequiresToggle), NULL);
  pgamentry15 = gtk_entry_new();
  gtk_container_add(GTK_CONTAINER(localhbox2), pgamentry15);
  localbutton = gtk_button_new_with_label("Browse");
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PgamSortBrowse15), NULL);
  ...
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(OutputHistToggle), NULL);
  //--ddc aug11  localgroup = gtk_radio_button_group(GTK_RADIO_BUTTON(localbutton));
  localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
  localbutton = gtk_radio_button_new_with_label(localgroup, "TAC Output");
  gtk_container_add(GTK_CONTAINER(framevbox), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(OutputTACToggle), NULL);
  //--ddc aug11  localgroup = gtk_radio_button_group(GTK_RADIO_BUTTON(localbutton));
  localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
  ...
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(OutputPartToggle), NULL);
  ...
  gtk_container_add(GTK_CONTAINER(framevbox), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(OutputNoMatrix), NULL);
  //--ddc aug11  localgroup = gtk_radio_button_group(GTK_RADIO_BUTTON(localbutton));
  localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
  localbutton = gtk_radio_button_new_with_label(localgroup, "2D Gamma Matrix Output Triangle");
  gtk_container_add(GTK_CONTAINER(framevbox), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(OutputTwdToggle), NULL);
  //--ddc aug11  localgroup = gtk_radio_button_group(GTK_RADIO_BUTTON(localbutton));
  localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
  localbutton = gtk_radio_button_new_with_label(localgroup, "2D Gamma Matrix Output Square");
  gtk_container_add(GTK_CONTAINER(framevbox), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(OutputGGSToggle), NULL);
  //--ddc aug11  localgroup = gtk_radio_button_group(GTK_RADIO_BUTTON(localbutton));
  localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
  ...
  localbutton = gtk_button_new_with_label("Browse");
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PgamSortBrowse5), NULL);

  localbutton = gtk_radio_button_new_with_label(localgroup, "2D Particle - Gamma Matrix Output");
  gtk_container_add(GTK_CONTAINER(framevbox), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(OutputSqrToggle), NULL);
  //--ddc aug11  localgroup = gtk_radio_button_group(GTK_RADIO_BUTTON(localbutton));
  localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
  localhbox2 = gtk_hbox_new(FALSE, 0);
  gtk_container_add(GTK_CONTAINER(framevbox), localhbox2);
  ...
  localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(OutputPairSqrToggle), NULL);
  pgamentry13 = gtk_entry_new();
  gtk_container_add(GTK_CONTAINER(localhbox2), pgamentry13);
  localbutton = gtk_button_new_with_label("Browse");
  gtk_container_add(GTK_CONTAINER(localhbox2), localbutton);
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(PgamSortBrowse13), NULL);
...
void PgamReadDetectorInfo(char *sFilename) {
  ...
  if ((infile = fopen(sFilename, "r")) != NULL) {
    ...
    if (counter != numxdets)
      GetMessageDialog("Fail on detector xaxis info.\n");
    ...
    if (counter != numydets)
      GetMessageDialog("Fail on detector yaxis info.\n");
    fclose(infile);
  } else {
...
void PgamReadGammaGate(char *sFilename) {
  ...
  /* --- attempt a read back --- */
  for (i = 0; i < pgamgammagates.num; i++) {
    sprintf(dummystr, "1D Gate %d: %.1f to %.1f\n", i, pgamgammagates.min[i],
            pgamgammagates.max[i]);
    WriteMessageText(dummystr);
  }
}
  ...
  if ((infile = fopen(sFilename, "r")) != NULL) {
    ...
    if (num_adcs > 0) {
      ...
      for (i = 0; i < num_adcs; i++) {
        ...
        if (strstr(dummystr, "(") == NULL) {
          ...
          if (sscanf(dummystr, "%d,%d,%f", &hpges[i].adc, &hpges[i].channels, &hpges[i].angle) !=
              3) {
          ...
          if (sscanf(dummystr, "%d,%d(%d),%f", &hpges[i].adc, &hpges[i].channels,
                     &hpges[i].overflow, &hpges[i].angle) != 4) {
            GetMessageDialog("Error reading detector information from setup file.");
          } else {
            printf("hpge adc %d, channels %d, overflow starts at %d, angle %d\n", hpges[i].adc,
                   hpges[i].channels, hpges[i].overflow, hpges[i].angle);
          }
        }
        fgets(dummystr, 120, infile);
        while (strncmp("#", dummystr, 1) == 0) {
        ...
        if (sscanf(dummystr, "%f,%f,%f", &hpges[i].calib[0], &hpges[i].calib[1],
                   &hpges[i].calib[2]) != 3) {
          GetMessageDialog("Error reading detector calibration from setup file.");
          goto stopreading;
        } else
          printf("hpge calibration %f %f %f\n", hpges[i].calib[0], hpges[i].calib[1],
                 hpges[i].calib[2]);
      }
    }
    ...
    if (num_telescopes > 0) {
      ...
      for (i = 0; i < num_telescopes; i++) {
        ...
        if ((strstr(dummystr, ",") < strstr(dummystr, "(")) || (strstr(dummystr, "(") == NULL)) {
          ...
          for (k = 0; k < j; k++)
            telescopes[i].e_sup_adc[k] = tempints[k];
        }
        cptr = cptr + sizeof(char);
        ...
        if ((strstr(cptr, ",") > strstr(cptr, "(")) && (strstr(cptr, "(") != NULL)) {
          ...
          for (k = 0; k < j; k++)
            telescopes[i].de_sup_adc[k] = tempints[k];
        } else {
        ...
        if ((strstr(cptr, ",") < strstr(cptr, "(")) || (strstr(cptr, "(") != NULL)) {
          ...
          sscanf(cptr, "(%f,%f,%f)", &telescopes[i].sup_cal[0], &telescopes[i].sup_cal[1],
                 &telescopes[i].sup_cal[2]);
          printf("sup_cal: %f %f %f ", telescopes[i].sup_cal[0], telescopes[i].sup_cal[1],
                 telescopes[i].sup_cal[2]);
        ...
        cptr = strstr(cptr, ",");
        cptr = cptr + sizeof(char);
        if (sscanf(cptr, "%d", &telescopes[i].totaladc) != 1) {
          GetMessageDialog("Error reading Telescope information from setup file.");
          goto stopreading;
        } else
          printf("telescopes e_adc: %d delta_e_adc: %d gain: %f\n", telescopes[i].e_adc,
                 telescopes[i].delta_e_adc, telescopes[i].gain);
      }
    }
    ...
    if (sscanf(dummystr, "%d", &num_clovers) != 1) {
      ...
      printf("number of clovers %d\n", num_clovers);

    if (num_clovers > 0) {

      /* --- now we need to allocate memory for the multi-crystal detectors --- */

      clovers = (struct multi_hpge_info *)malloc(num_clovers * sizeof(struct multi_hpge_info));
      ...
      for (i = 0; i < num_clovers; i++) {
        ...
        if (sscanf(dummystr, "%d,%d", &clovers[i].num_adcs, &clovers[i].totadc) != 2) {
          ...
          printf("clover: num crystals %d sum adc: %d\n", clovers[i].num_adcs, clovers[i].totadc);
        ...
        while (counter < clovers[i].num_adcs) {
          ...
          test = sscanf(dummystr, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d", &tempints[0], &tempints[1],
                        &tempints[2], &tempints[3], &tempints[4], &tempints[5], &tempints[6],
                        &tempints[7], &tempints[8], &tempints[9]);
          for (j = 0; j < test; j++) {
    ...
    if (num_tacs > 0) {
      ...
      for (i = 0; i < num_tacs; i++) {
        ...
        if (sscanf(dummystr, "%d", &tacs[i].num_adcs) != 1) {
          ...
          printf("number of adcs with in tac %d\n", tacs[i].num_adcs);
        /* --- now we have to allocate memory to put the gate info into --- */
        tacs[i].gates =
            (struct tac_gate_info *)malloc(tacs[i].num_adcs * sizeof(struct tac_gate_info));
        for (j = 0; j < tacs[i].num_adcs; j++) {
          fgets(dummystr, 120, infile);
          while (strncmp("#", dummystr, 1) == 0) {
            fgets(dummystr, 120, infile);
          }
          if (sscanf(dummystr, "%d,%d,%d", &tacs[i].gates[j].adc, &tacs[i].gates[j].min,
                     &tacs[i].gates[j].max) != 3) {
            GetMessageDialog("Error reading tac gate info from setup file.");
            goto stopreading;
          } else
            printf("TAC gate adc: %d, min: %d, max: %d\n", tacs[i].gates[j].adc,
...
void PgamSort() {
  ...
  for (i = 0; i < num_setups; i++) {
    ...
    if (num_telescopes > most_telescopes)
      most_telescopes = num_telescopes;
    if (num_adcs != 0) {
      for (j = 0; j < num_adcs; j++) {
        if (hpges[j].channels > max_channels)
          max_channels = hpges[j].channels;
        if (adc_map == NULL) {
      ...
      for (j = 0; j < num_telescopes; j++) {
        if (adc_map == NULL) {
          ...
          test = 0;
          for (k = 0; k < max_adcs; k++) {
            if (telescopes[j].totaladc == adc_map[k])
              test = 1;
          }
          if (test == 0) {
            max_adcs++;
  ...
  //--ddc biggest_adc = 0;
  if (d_max_adcs > max_adcs)
    biggest_adc = d_max_adcs;
  else
    biggest_adc = 0;

  for (i = 0; i < max_adcs; i++) {
    inverse_adc_map[i] = adc_map[i];
    if (inverse_adc_map[i] > biggest_adc)
      biggest_adc = inverse_adc_map[i];
  }
  ...
  if ((pgamsortoutputtac)) { // this is the case for tac output
    ...
    if (pgamsortoutputpart) {
      if (big_data_info == NULL) {
        ...
        big_data_info = (struct bigdata **)realloc(big_data_info, sizeof(struct bigdata *) *
  ...
  for (i = 0; i < num_setups; i++) { // go through all the setup files
    ...
    for (k = 0; k < max_adcs; k++) {
      for (l = 0; l < num_adcs; l++) {
        if (adc_map[hpges[l].adc] == k)
          detector_info_map[k] = l;
      }
    }
    ...
    if (telescope_gate == NULL) {
      ...
      telescope_gate = (unsigned long long *)realloc(telescope_gate,
    ...
    for (k = 0; k < num_telescopes; k++) {
      ...
      if (adc_map[telescopes[k].e_adc] != -1) {
        telescope_gate[adc_map[telescopes[k].e_adc]] |=
            (unsigned long long)((unsigned long long)1 << k);
        //	telescope_gate[adc_map[telescopes[k].delta_e_adc]] = k+1;
      }
    }

    if (special_telescope_gate == NULL) {
      special_telescope_gate =
          (unsigned long long *)malloc((max_adcs + 1) * sizeof(unsigned long long));
    } else {
      special_telescope_gate = (unsigned long long *)realloc(
          special_telescope_gate, (max_adcs + 1) * sizeof(unsigned long long));
    }
    for (k = 0; k < max_adcs; k++)
      special_telescope_gate[k] = 0;
    for (k = 0; k < num_telescopes; k++) {
      if ((adc_map[telescopes[k].e_adc] != -1) && (telescopes[k].special)) {
        special_telescope_gate[adc_map[telescopes[k].e_adc]] |=
            (unsigned long long)((unsigned long long)1 << k);
      }
      if ((adc_map[telescopes[k].delta_e_adc] != -1) && (telescopes[k].special))
        special_telescope_gate[adc_map[telescopes[k].delta_e_adc]] |=
            (unsigned long long)((unsigned long long)1 << k);
    }
    ...
    for (k = 0; k < num_telescopes; k++) {
      if (adc_map[telescopes[k].delta_e_adc] != -1) {
        detelescope_gate[adc_map[telescopes[k].delta_e_adc]] |=
            (unsigned long long)((unsigned long long)1 << k);
      }
    }
    ...
    if (truesingles) {
      ...
      inverse_adc_map = (int *)g_realloc(inverse_adc_map, sizeof(int) * (biggest_adc + 1));
    ...
    for (j = tempmin; j <= tempmax; j++) { // runs
      ...
      if ((infile = fopen(filename, "r")) != NULL) { // we managed to open the file
        ...
        while (stillreading) {
           ...
           * --- */
          if (datafiletype != 1) {
            if (fread(&buffersize[1], sizeof(int), 1, infile) == 0)
              goto stopreading;
          ...
          nextheader:
            ...
            default:
              ...
              if (head > 0) {
                ...
                //--ddc 1may06  Surely, JP did NOT intend to throw away high multiplicty events!
                //Each of these 'event cases'
                // MUST allow numadc to be as great as the number of ADCs.  Also, this test seems to
                // be redundant after the first test, but, I will leave it.
                ...
                if ((numadc >= 1) && (numadc <= biggest_adc)) { // adc check
                  ...
                  if (k >= numshorts)
                    goto bufferdone;
                  //--ddc		  if ((numadc >= 2) && (numadc <= num_adcs)) { // second adc
                  //check
                  ...
                  if ((numadc >= 3) && (numadc <= biggest_adc)) { // third adc check
                    //--ddc AND here, we must do the sum over the actual number of adcs, not the
                    //number we are using!!
                    ...
                    for (l = 2; l < numadc; l++) {
                      ...
                      if (k >= numshorts)
                        goto bufferdone;
                      m = buffer[k];
                      //--ddc 1may07  Oops. it is clearly possible that m is less than zero, however
                      //JP didn't test this until AFTER using m to update event_adcs.  I have copied
                      // the test for m to here, where it will do even more good.
                      if (m < 0) {
                        goto writevent;
                      }
                      if ((adc_map[m] >= 0) && (adc_map[m] < max_adcs) && (m <= biggest_adc)) {
                    ...
                    if ((numadc < 0) || (numadc > biggest_adc)) {
                      GetMessageDialog("Either a negative number of ADCs fired or more ADCs fired "
                                       "than possible.\n");
                      goto stopreading;
                    }
              ...
              for (l = 0; l < numadc; l++) {
                if ((event_channel[l] < max_channels) && (event_adcs[l] >= 0))
                  ...
                  if (event_channel[l] < 1) {
                    //--ddc only print for dbg.	 printf("error filling raw histogram = %d,
              ...
              *(histloc[biggest_adc] + 32 + numadc) += 1;
              ...
              if (num_telescopes) { // provide we have some
                for (l = 0; l < numadc; l++) {
                  ...
                  if (event_adcs[l] < 0 || event_adcs[l] > singles_gates)
                    continue;
                  ...
                  if (telescope_gate[event_adcs[l]]) {
                    for (ll = 0; ll < numadc; ll++) {
                      ...
                      //              mapped to -1!!! so skip the rest if this is true!
                      //--ddc 2may07  add skip for adcs with no gate mapped
                      if (event_adcs[ll] < 0 || event_adcs[ll] > singles_gates)
                        continue;
              ...
              if (num_clovers) { // provided we have some
                ...
                for (l = 0; l < num_clovers; l++)
                  clover_hit[l] = 0;
                for (l = 0; l < numadc; l++) {
                  //--ddc debug.  If an event had an adc that was not in a map (or has no map), it
                  //is
                  //              mapped to -1!!! so skip the rest if this is true!
                  //--ddc 2may07  add skip for adcs with no gate mapped
                  if (event_adcs[l] < 0 || event_adcs[l] >= singles_gates)
                  ...
                  if (clover_gates[event_adcs[l]]) {
                    ...
                    if (!(clover_hit[BitLog2(clover_gates[event_adcs[l]])])) {
                      ...
                      /* --- now we cycle through the rest of the event to gather the multiplicity
                         of
                         --- that detector --- */
                      for (ll = 0; ll < numadc; ll++) {
                        //--ddc debug.  If an event had an adc that was not in a map (or has no
                        //map), it is
                        //              mapped to -1!!! so skip the rest if this is true!
                        //--ddc 2may07  add skip for adcs with no gate mapped
                        if (event_adcs[ll] < 0 || event_adcs[ll] >= singles_gates)
              ...
              /* --- if there are telescopes, we need to know how may were hit, otherwise, leave it
               * alone --- */
              if (num_telescopes) {
                telescopes_hit = 0;
                for (l = 0; l < numadc; l++) {
              ...
              /* --- perhaps it would make sense to do the veto gates first since they should cut
                 out
                ...
                for (l = 0; l < numadc; l++) {
                  ...
                  for (m = 0; m < vetos->num; m++) {
                    if ((event_adcs[l] == adc_map[vetos->adc[m]]) && (event_adcs[l] != -1)) {
                      if ((event_channel[l] >= vetos->min[m]) &&
                          (event_channel[l] <= vetos->max[m])) {
                        failvetogate = 1;
                        goto failedvetogate;
                      }
                    }
              ...
              /* --- ok, to speed things up let's try unpacking from channels to energy at the
               * beginning --- */

              /* --- to try and save time let's look to the statistics we gathered earlier and the
                 output types
                 --- which we are using --- */
              ...
              if (pgamsortoutputpart) {
                ...
                if (pgamsortoutputgg) {
                  if ((numadc - telescopes_hit) < 2)
                    goto nextheader;
                } else {
                  if (pgamsortoutputsqr) {
                    if (!((telescopes_hit) && ((numadc - telescopes_hit) > 1)))
                      goto nextheader;
                  } else {
                    if (pgamsortoutputpairsqr)
              ...
              for (l = 0; l < numadc; l++) {
                ...
                if (detector_info_map[event_adcs[l]] < 0)
                  continue;

                if (event_channel[l] >= hpges[detector_info_map[event_adcs[l]]].overflow)
              ...
              for (l = 0; l < numadc; l++) {
                ...
                uchanm[l] =
                    (float)(((hpges[detector_info_map[event_adcs[l]]].calib[0] +
                             ...
                             (float)fin_cal) /
                            (float)(1 + beta * ftaux *
                                            cos(hpges[detector_info_map[event_adcs[l]]].angle *
                                                0.01745329)));
                uchanp[l] =
                    (float)(((hpges[detector_info_map[event_adcs[l]]].calib[0] +
                              hpges[detector_info_map[event_adcs[l]]].calib[1] *
              ...
              /* --- now we should do the requires gate since that should also cut out a lot of
               * stuff --- */
              if (pgamsortgaterequires) {
                ...
                for (l = 0; l < numadc; l++) {
                  ...
                  for (m = 0; m < requires->num; m++) {
                    if ((event_adcs[l] == adc_map[requires->adc[m]]) && (event_adcs[l] != -1)) {
                      if ((event_channel[l] >= requires->min[m]) &&
                          (event_channel[l] <= requires->max[m])) {
                        failrequiresgate = 0;
              ...
              /* --- if we are sorting with something that would use telescopes, let's unpack the
                 --- telescopes --- */
              num_scopes = 0;
              if ((pgamsortgatepart || pgamsortoutputhists || pgamsortoutputpart ||
                   pgamsortoutputsqr || pgamsortgateparten) &&
                  (telescopes_hit >= 1)) {
                  ...
                  if (telescope_gate[event_adcs[l]]) {
                    for (ll = 0; ll < most_telescopes; ll++) {
                      ...
                      if (detelescope_gate[event_adcs[z]] & telescope_gate[event_adcs[l]] &
                          (unsigned long long)((unsigned long long)1 << ll)) {
                        tellook = LongBitLog2(
                            (detelescope_gate[event_adcs[z]] & telescope_gate[event_adcs[l]]) &
                            (unsigned long long)((unsigned long long)1 << ll));
                        // if (tellook > 32) {
                        //  printf("Just a trap.\n");
                        // }
                        /* --- we would like to try to use the supplamental ADC channels for both of
                           the
                           --- E and dE detectors --- */
                        /* --- in order to do this, we scan through the rest of the event to
                           determine
                        ...
                        if (telescopes[tellook].num_e_sup) {
                          ...
                          if (e_sup_hits) {
                            ...
                            for (n = 0; n < e_sup_hits; n++) {
                              if (uchanm[l] < uchanm[e_sup_ent[n]])
                                goto nextlpresortpart;
                            }
                          }
                        }
                        ...
                        if (telescopes[tellook].num_de_sup) {
                          ...
                          if (de_sup_hits) {
                            ...
                            for (n = 0; n < de_sup_hits; n++) {
                              if (uchanm[z] < uchanm[de_sup_ent[n]])
                                goto nextlpresortpart;
                            }
                          }
                        }
                        ...
                        if (!telescopes[tellook].special) {
                          ...
                          //  scope_newm[num_scopes] = uchanm[l] + uchanm[z] *
                          //  telescopes[tellook].gain;
                          // scope_newp[num_scopes] = uchanp[l] + uchanp[z] *
                          // telescopes[tellook].gain;
                        ...
                        scope_y[num_scopes] =
                            (float)uchanm[z] / (float)fin_chans * (float)edesize / (float)telfincal;
                        ...
                        for (n = 0; n < e_sup_hits; n++) {
                          ...
                          // scope_x[num_scopes] += uchanm[e_sup_ent[n]] / (float) fin_chans *
                          // (float) edesize /
                          //  (float) telfincal;
                        }
                        ...
                        for (n = 0; n < de_sup_hits; n++) {
                          ...
                          // scope_x[num_scopes] += uchanm[de_sup_ent[n]] / (float) fin_chans *
                          // (float) edesize /
                          //  (float) telfincal * telescopes[tellook].gain;
                          scope_y[num_scopes] += uchanm[de_sup_ent[n]] / (float)fin_chans *
                                                 (float)edesize / (float)telfincal;
                        }

                        /* --- adding the supplamental calibration --- */
                        //--ddc 17jan06// Note... scope_y does NOT have partfincal applied, but
                        //because where JP chose to
                        //--ddc 17jan06// do the final calculation for scope_x IT does have
                        //partfincal applied!
                        //--ddc Fix this by removing partfincal here, and applying AFTER the
                        //gates... the scope_x
                        //--ddc final calculation being LEFT where JP left it for now... Ah, so it
                        ...
                        scope_newm[num_scopes] =
                            (telescopes[tellook].sup_cal[0] +
                             telescopes[tellook].sup_cal[1] * tempfloatm +
                             telescopes[tellook].sup_cal[2] * tempfloatm * tempfloatm) /
                            (float)fin_cal;
                        scope_newp[num_scopes] =
                            (telescopes[tellook].sup_cal[0] +
                             telescopes[tellook].sup_cal[1] * tempfloatp +
                             telescopes[tellook].sup_cal[2] * tempfloatp * tempfloatp) /
                            (float)fin_cal;
                      ...
                      if (telescopes[scope_addr[l]].e_adc == tacs[m].adc) {
                        ...
                        for (n = 0; n < tacs[m].num_adcs; n++) {
                          if (telescopes[scope_addr[l]].delta_e_adc == tacs[m].gates[n].adc) {
                            passtacgateb = GateDataStructTest(gate_info, scope_addr[l], scope_x[l],
                                                              scope_y[l]);
                            if (passtacgateb)
                              goto passtacgateb;
                          }
              ...
              if ((pgamsortgateparten)) {
                ...
                if ((partenergies[0] == -1) || (partenergies[1] == -1))
                  goto stopsort;
              ...
              if ((pgamsortgatepart)) {
                ...
                if (num_scopes > 0) {
                  for (l = 0; l < num_scopes; l++) {
                    if ((0 < scope_x[l]) && (scope_x[l] < gate_info->axes[0]) && (0 < scope_y[l]) &&
                        (scope_y[l] < gate_info->axes[1])) {
                      if (GateDataStructTest(gate_info, scope_addr[l], scope_x[l], scope_y[l])) {
                        // if (BigDataStructGetVal(gate_info,scope_x[l],scope_y[l]) & (uint)((uint)1
                        // << scope_addr[l])) {
                        passpartgate = 1;
                        goto passpartgate;
                      }
                ...
                if (pgamgammagates.num) {
                  ...
                  for (l = 0; l < numadc; l++) {
                    ...
                    for (m = 0; m < pgamgammagates.num; m++) {
                      if ((anewm2 * fin_cal >= pgamgammagates.min[m]) &&
                          (anewp2 * fin_cal <= pgamgammagates.max[m])) {
                        passgammagate++;
                      }
                    }
              ...
              passedgammagate:
                if (!(passgammagate >= pgam1dgatemin))
                  goto nextheader;
              ...
              if (pgamsortoutputhists) {
                ...
                for (l = 0; l < numadc; l++) {
                  ...
                  if ((pgamsortgategamma) && (passgammagate)) {
                    ...
                    for (o = 0; o < pgamgammagates.num; o++) {
                      if ((anewm2 * fin_cal >= pgamgammagates.min[o]) &&
                          (anewp2 * fin_cal <= pgamgammagates.max[o])) {
                        anewm2 = anewp2 = -1;
                        goto nextlhist;
                      }
                      if ((anewm * fin_cal >= pgamgammagates.min[o]) &&
                          (anewp * fin_cal <= pgamgammagates.max[o])) {
                        ...
                        if (anewp2 != anewm2) {
                          ...
                          for (o = newm; o <= newp; o++) {
                            ...
                            if (clover_hit[BitLog2(clover_gates[event_adcs[l]])] >=
                              ...
                              *(temphist[adc_map[clovers[BitLog2(clover_gates[event_adcs[l]])]
                                                     .totadc]] +
                                o) =
                                  *(temphist[adc_map[clovers[BitLog2(clover_gates[event_adcs[l]])]
                                                         .totadc]] +
                    ...
                    if ((newm > 0) && (newp < fin_chans)) {
                      ...
                      for (m = newm; m <= newp; m++) {
                        ...
                        if (tp > ((float)m + 0.5))
                          tp = ((float)m + 0.5);
                        if (event_adcs[l] >= 0)
                          *(temphist[event_adcs[l]] + m) =
                              *(temphist[event_adcs[l]] + m) + (frac * (tp - tm));
                ...
                if ((num_scopes) && (telescopes_hit >= 1)) {
                  for (ll = 0; ll < num_scopes; ll++) {
                    ...
                    if ((scope_newm[ll] - newm) > 0.5)
                      newm++;
                    if ((scope_newp[ll] - newp) > 0.5)
                      newp++;
                    if ((newm > 0) && (newp < fin_chans)) {
              ...
              if ((pgamsortoutputpart) && (num_scopes > 0)) {
                for (l = 0; l < num_scopes; l++) {
                  if ((0 <= scope_x[l]) &&
                      (scope_x[l] <
                       big_data_info[pgammax - most_telescopes + scope_addr[l]]->axes[0]) &&
                      (0 < scope_y[l]) &&
                      (scope_y[l] <
                       big_data_info[pgammax - most_telescopes + scope_addr[l]]->axes[1]))
                ...
                for (l = 0; l < numadc; l++) {
                  ...
                  if (((!(telescope_gate[event_adcs[l]]) && !(detelescope_gate[event_adcs[l]])) ||
                    ...
                    if (num_clovers) {
                      /* --- we have clovers --- */
                      if ((clover_gates[event_adcs[l]]) &&
                          (!(clover_hit[BitLog2(clover_gates[event_adcs[l]])]))) {
                ...
                for (l = 0; l < g_num; l++) {
                  ...
                  if ((pgamsortgategamma) && (passgammagate)) {
                    for (q = 0; q < pgamgammagates.num; q++) {
                      if ((g_newm[l] * fin_cal >= pgamgammagates.min[q]) &&
                          (g_newp[l] * fin_cal <= pgamgammagates.max[q]))
                        goto nextgammapartsqr;
                    }
                  }
                  for (m = 0; m < num_scopes; m++) {
                    /* --- first let's deal with the energy particle gate --- */
                    if ((scope_newm[m] >= partenergies[0]) && (scope_newp[m] <= partenergies[1]) &&
                        pgamsortgateparten)
                      goto nextpartpartsqr;
                    newm = (int)g_newm[l];
                    newp = (int)g_newp[l];
                    if ((g_newm[l] - newm) > 0.5)
                      newm++;
                    if ((g_newp[l] - newp) > 0.5)
                      newp++;
                    if ((newm > 0) && (newp < pgammatrixdata.size)) {
                      if (g_newp[l] != g_newm[l])
                        frac = 1.0 / (g_newp[l] - g_newm[l]);
                      else
                        frac = 0;
                      newme = (int)scope_newm[m];
                      newpe = (int)scope_newp[m];
                      if ((scope_newm[m] - newme) > 0.5)
                        newme++;
                      if ((scope_newp[m] - newpe) > 0.5)
                        newpe++;
                      if ((newme > 0) && (newpe < pgammatrixdata.size)) {
                        if (scope_newm[m] != scope_newp[m])
                          frace = 1.0 / (scope_newp[m] - scope_newm[m]);
                        else
                          frace = 0;
                        for (n = newm; n <= newp; n++) {
                          tm = g_newm[l];
                          ...
                          for (o = newme; o <= newpe; o++) {
                            ...
                            if (tpe > ((float)o + 0.5))
                              tpe = ((float)o + 0.5);
                            *(pgammatrixdata.data + pgammatrixdata.size * n + o) +=
                                frac * frace * (tp - tm) * (tpe - tme);
                          }
                        }
                      }
                    }
              ...
              if ((pgamsortoutputgg) && ((numadc) > 1)) {
                ...
                /* --- the best way to do this is to begin by constructing the list of events for
                   each axis
                   --- for each axis --- */
                  ...
                  if (num_clovers) {
                    ...
                    if (clover_gates[event_adcs[l]]) {
                      ...
                      if ((clover_hit[BitLog2(clover_gates[event_adcs[l]])])) {
                        ...
                        //--ddc ??!! the entire concept of virtual adc seems to be moot for 2d
                        //arrays
                        //--ddc ??!! if one were to fill the virtual adc here, it would have to be
                        //(it appears)
                        //--ddc ??!! put into the arrays (xadcs,yadcs,etc) in case2 in the next "if"
                        //right here....
                    ...
                    /* --- ok, now we have the new upper and lower channel numbers,
                       let us now determine if this event belongs in either the x or y (or both)
                       lists --- */
                  }
                  if ((anewm > 0) && (anewp > 0)) {
                    switch (pgamsortoutputggtype) {
                    case 1:
                      ...
                      if (!(tacgate[event_adcs[l]]) && ((!(telescope_gate[event_adcs[l]]) &&
                ...
                if (pgamsortgategamma) {
                  ...
                  //--ddc 22jun06 now, IF there is ANY gated gamma, go through and put the rest in
                  //the
                    ...
                    for (l = 0; l < xaxiscount; l++) {
                      ...
                      for (m = 0; m < yaxiscount; m++) {
                        ...
                        if ((anewp3 - newp3) > 0.5)
                          newp3++;
                        if (anewp3 != anewm3)
                          frac3 = 1.0 / (anewp3 - anewm3);
                        if ((newm >= 0) && (newp < pgammatrixdata.size) && (newm3 >= 0) &&
                            (newp3 < pgammatrixdata.size)) {
                          for (n = newm; n <= newp; n++) {
                            /* --- x-axis variables --- */
                            tm = anewm;
                            tp = anewp;
                            ...
                            for (o = newm3; o <= newp3; o++) {
                              ...
                              if ((n < pgammatrixdata.size) && (o < pgammatrixdata.size)) {
                                ...
                                case 1:
                                  if (l > m) {
                                    index = Max(n, o) - Min(n, o) +
                                            (isize - Min(n, o)) * ((float)Min(n, o) / (float)2);
                ...
                //		  if (pgamsortgategamma) {
                //   for (m = 0; m < pgamgammagates.num; m++) {
                //     if ((anewm * fin_cal >= pgamgammagates.min[m]) && (anewp * fin_cal <=
                //     pgamgammagates.max[m])) {
                //	whichgamma = m;
                //	if (passgammagate == 1)
                //	  goto nextlgg;
                //     }
                ...
                for (l = 0; l < numadc; l++) {
                  ...
                  for (m = 0; m < pairs->num; m++) {
                    if (((uint)(1 << event_adcs[l])) & pair_flags[m]) {
                      ...
                      //--ddc oct14 if we don't want to double count, we only check the remaining
                      //adcs... n should start with l
                          ...
                          if (fin_cal > 0) {
                            ...
                            if ((newm > 0) && (newp < fin_chans)) {
                              ...
                              for (o = 0; o < numadc; o++) {
                                ...
                                if ((o != l) && (o != n) &&
                                    (((!(telescope_gate[event_adcs[o]])) &&
                                      (!(detelescope_gate[event_adcs[o]]))) ||
                                     special_telescope_gate[event_adcs[o]]) &&
                                  ...
                                  if (num_clovers) {
                                    ...
                                    if (clover_gates[event_adcs[o]]) {
                                       ...
                                       * --- */
                                      if ((clover_gates[event_adcs[l]] &
                                           clover_gates[event_adcs[o]]) ||
                                          (clover_gates[event_adcs[n]] &
                                           clover_gates[event_adcs[o]])) {
                                        //--ddc nov14 can't toss EVERYTHING because the pair is in
                                        //ANY clover!!
                                        //--ddc newm = -1;
                                        //--ddc newp = -1;
                                        //--ddc nov14 BUT if we set the 'clover_hit' for clover with
                                        //event_adcs[o]
                                        //--ddc nov14 AND just let it continue, this clover is
                                        //excluded, but
                                        //--ddc nov14 the pair should still be histogrammed with
                                        //other clovers..
                                        //--ddc nov14 HOWEVER for testing accept all events with a
                                        //possible pair
                                      ...
                                      if (clover_hit[BitLog2(clover_gates[event_adcs[o]])]) {
                                        /* --- this is the case where we have already used the
                                         * clover --- */
                                        anewm2 = -1;
                                        anewp2 = -1;
                                      } else {
                                        ...
                                        //--ddc oct14.  Fix index for clover_hit array... not for
                                        //adc 'l'! clover_hit[BitLog2(clover_gates[event_adcs[l]])]
                                        // = 1;
                                        clover_hit[BitLog2(clover_gates[event_adcs[o]])] = 1;

                                        /* --- now lets start the add-back function --- */
                                        for (p = 0; p < numadc; p++) {
                                          //--ddc debug.  If an event had an adc that was not in a
                                          //map, it is
                                          //              mapped to -1!!! so skip the rest if this
                                          //              is true!
                                          if (event_adcs[p] < 0)
                                            continue;

                                          //--ddc nov14 LOOKS like a redundancy, test on l and n ...
                                          //removing if ((p != o) && (p != l) && (p != n) &&
                                          if ((p != o) && (clover_gates[event_adcs[o]] &
                                                           clover_gates[event_adcs[p]])) {
                                            //--ddc oct14.  Fix index for clover_hit array... not
                                            //for adc 'l'!
                                            // clover_hit[BitLog2(clover_gates[event_adcs[l]])] +=
                                            // 1;
                                  ...
                                  if ((anewm2 != -1) && (anewp2 != -1)) {
                                    ...
                                    if (anewm2 != anewp2)
                                      frac2 = 1.0 / (anewp2 - anewm2);
                                    if ((newm2 > 0) && (newp2 < fin_chans) && (newm > 0) &&
                                        (newp < fin_chans)) {
                                      for (p = newm; p <= newp; p++) {
                                        tm = anewm;
                                        tp = anewp;
...
int PassTACGate(int adc, int channel) {
  ...
  if (num_tacs == 0) {
    ...
    for (i = 0; i < num_tacs; i++) {
      for (j = 0; j < tacs[i].num_adcs; j++) {
        if ((adc == tacs[i].gates[j].adc) && (channel >= tacs[i].gates[j].min) &&
            (channel <= tacs[i].gates[j].max)) {
          return (1);
        }
      }
    }
...
void PgamPairsAdd(struct pgam_pairs *pairs, int a, int b) {
  if (pairs->pairs == NULL) {
    ...
    pairs->num += 1;
    pairs->pairs = (struct pgam_pair *)realloc(pairs->pairs, sizeof(struct pgam_pair) * pairs->num);
  }
