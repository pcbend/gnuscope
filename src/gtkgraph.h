...
extern "C" {
  ...
  enum gtk_graph_scale_type {GTK_GRAPH_SCALE_CHANNELS,
			     GTK_GRAPH_SCALE_CALIBRATED};

  enum gtk_graph_type {GTK_GRAPH_TYPE_LINEAR,
		       GTK_GRAPH_TYPE_SEMILOG,
		       GTK_GRAPH_TYPE_SEMISQRT};

  enum gtk_graph_y_scale_mode{GTK_GRAPH_Y_SCALE_AUTO_OFF,
