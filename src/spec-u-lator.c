...
void CreateSpecULatorWindow() {
  ...
  while (histsize[i] > 0) {
    if ((i % 10) == 0) {
      ...
      gtk_table_attach(GTK_TABLE(frametable), locallabel, 0, 1, 0, 1, GTK_SHRINK, GTK_SHRINK, 0, 0);
      locallabel = gtk_label_new("+");
      gtk_table_attach(GTK_TABLE(frametable), locallabel, 1, 2, 0, 1, GTK_SHRINK, GTK_SHRINK, 0, 0);
      locallabel = gtk_label_new("-");
      gtk_table_attach(GTK_TABLE(frametable), locallabel, 2, 3, 0, 1, GTK_SHRINK, GTK_SHRINK, 0, 0);
      locallabel = gtk_label_new("Histogram:");
      gtk_table_attach(GTK_TABLE(frametable), locallabel, 5, 6, 0, 1, GTK_SHRINK, GTK_SHRINK, 0, 0);
    }
    ...
    gtk_table_attach(GTK_TABLE(frametable), localbutton, 0, 1, (i % 10) + 1, (i % 10) + 2,
                     GTK_SHRINK, GTK_SHRINK, 0, 0);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(localbutton), TRUE);
    localbutton = gtk_radio_button_new(localgroup);
    //--ddc aug11      localgroup = gtk_radio_button_group(GTK_RADIO_BUTTON(localbutton));
    localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
    gtk_table_attach(GTK_TABLE(frametable), localbutton, 1, 2, (i % 10) + 1, (i % 10) + 2,
                     GTK_SHRINK, GTK_SHRINK, 0, 0);
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(SpecULatorAddCallback),
                     (int *)i);
    localbutton = gtk_radio_button_new(localgroup);
    //--ddc aug11      localgroup = gtk_radio_button_group(GTK_RADIO_BUTTON(localbutton));
    localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
    gtk_table_attach(GTK_TABLE(frametable), localbutton, 2, 3, (i % 10) + 1, (i % 10) + 2,
                     GTK_SHRINK, GTK_SHRINK, 0, 0);
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(SpecULatorSubtractCallback),
                     (int *)i);
    locallabel = gtk_label_new("*");
    gtk_table_attach(GTK_TABLE(frametable), locallabel, 3, 4, (i % 10) + 1, (i % 10) + 2,
                     GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(frametable), localentry, 4, 5, (i % 10) + 1, (i % 10) + 2,
                     GTK_SHRINK, GTK_SHRINK, 0, 0);
    g_signal_connect(GTK_OBJECT(localentry), "changed", G_CALLBACK(SpecULatorNormCallback),
                     (int *)i);
    sprintf(dummystr, "%d: %s", i + 1, field2[i]);
    locallabel = gtk_label_new(dummystr);
    gtk_table_attach(GTK_TABLE(frametable), locallabel, 5, 6, (i % 10) + 1, (i % 10) + 2,
                     GTK_SHRINK, GTK_SHRINK, 0, 0);
  ...
  while (histsize[i] > 0) {
    ...
    //--ddc aug11      localgroup = gtk_radio_button_group(GTK_RADIO_BUTTON(localbutton));
    localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(SpecULatorOutputCallback),
                     (int *)i);
    gtk_table_attach(GTK_TABLE(frametable), localbutton, 0, 1, (i % 10) + 1, (i % 10) + 2,
                     GTK_SHRINK, GTK_SHRINK, 0, 0);
    sprintf(dummystr, "%d:", i + 1);
    locallabel = gtk_label_new(dummystr);
    gtk_table_attach(GTK_TABLE(frametable), locallabel, 1, 2, (i % 10) + 1, (i % 10) + 2,
                     GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    g_signal_connect(GTK_OBJECT(localentry), "changed", G_CALLBACK(SpecULatorTitleChanged),
                     (int *)i);
    gtk_table_attach(GTK_TABLE(frametable), localentry, 2, 3, (i % 10) + 1, (i % 10) + 2,
                     GTK_SHRINK, GTK_SHRINK, 0, 0);
    i++;
  ...
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(SpecULatorOutputCallback),
                   (int *)i);
  gtk_table_attach(GTK_TABLE(frametable), localbutton, 0, 1, (i % 10) + 1, (i % 10) + 2, GTK_SHRINK,
                   GTK_SHRINK, 0, 0);
  sprintf(dummystr, "%d:", i + 1);
  locallabel = gtk_label_new(dummystr);
  gtk_table_attach(GTK_TABLE(frametable), locallabel, 1, 2, (i % 10) + 1, (i % 10) + 2, GTK_SHRINK,
                   GTK_SHRINK, 0, 0);
  localentry = gtk_entry_new_with_max_length(20);
  gtk_widget_set_usize(localentry, 80, 20);
  gtk_entry_set_text(GTK_ENTRY(localentry), field2[i]);
  g_signal_connect(GTK_OBJECT(localentry), "changed", G_CALLBACK(SpecULatorTitleChanged), (int *)i);
  gtk_table_attach(GTK_TABLE(frametable), localentry, 2, 3, (i % 10) + 1, (i % 10) + 2, GTK_SHRINK,
                   GTK_SHRINK, 0, 0);
  i++;
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(localbutton), TRUE);
  ...
  g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(SpecULatorGo), NULL);
