...
#define GTK_TWODPLOT(obj) G_TYPE_CHECK_INSTANCE_CAST(obj, gtk_twodplot_get_type(), GtkTwodplot)
#define GTK_TWODPLOT_CLASS(klass)                                                                  \
  GTK_CHECK_CLASS_CAST(klass, gtk_twodplot_get_type, GtkTwodplotClass)
#define GTK_IS_TWODPLOT(obj) G_TYPE_CHECK_INSTANCE_TYPE(obj, gtk_twodplot_get_type())

/* --- enumration for the type of plotting --- */
enum gtk_twodplot_type {
  GTK_TWODPLOT_CONTOUR_ONLY,
  GTK_TWODPLOT_DENSITY_ONLY,
  GTK_TWODPLOT_CONTOUR_AND_DENSITY
};

enum gtk_twodplot_contour_type {
  GTK_TWODPLOT_CONTOUR_TYPE_LINEAR,
...
enum gtk_twodplot_density_type { GTK_TWODPLOT_DENSITY_TYPE_COLOR, GTK_TWODPLOT_DENSITY_TYPE_BW };

enum gtk_twodplot_interpolation_type {
  GTK_TWODPLOT_INTERPOLATION_OFF,
...
enum gtk_twodplot_fade { GTK_TWODPLOT_FADE_ON, GTK_TWODPLOT_FADE_OFF };
