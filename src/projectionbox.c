...
void ProjectWindow() {
  ...
  if (!GTK_IS_WIDGET(projectionwindow)) {
    ...
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(ProjectAddMarkersCallback),
                     NULL);
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(localbutton),"clicked",
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(ProjectAddRangeCallback), NULL);
    ...
    gtk_container_add(GTK_CONTAINER(framevbox), localbutton);
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(localbutton),"clicked",
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(ProjectSubtractMarkersCallback),
                     NULL);
    gtk_widget_show(localbutton);
    ...
    gtk_container_add(GTK_CONTAINER(localhbox), localbutton);
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(localbutton),"clicked",
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(ProjectSubtractRangeCallback),
                     NULL);
    ...
    gtk_container_add(GTK_CONTAINER(localhbox), localbutton);
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(localbutton),"clicked",
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(ProjectSubtractFracCallback),
                     NULL);
    ...
    localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(localbutton),"clicked",
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(ProjectXAxisCallback), NULL);
    localbutton = gtk_radio_button_new_with_label(localgroup, "Y-axis");
    gtk_container_add(GTK_CONTAINER(framevbox), localbutton);
    //--ddc aug11    localgroup = gtk_radio_button_group(GTK_RADIO_BUTTON(localbutton));
    localgroup = gtk_radio_button_get_group(GTK_RADIO_BUTTON(localbutton));
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(localbutton),"clicked",
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(ProjectYAxisCallback), NULL);
    ...
    //--ddc aug11   gtk_signal_connect(GTK_OBJECT(localbutton),"clicked",
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(FullProjectCallback), NULL);
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(localbutton),"clicked",
    g_signal_connect(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(ProjectCallback), NULL);
    //--ddc aug11    gtk_signal_connect_object(GTK_OBJECT(localbutton),"clicked",
    g_signal_connect_swapped(GTK_OBJECT(localbutton), "clicked", G_CALLBACK(HideWidget),
                             GTK_OBJECT(projectionwindow));
    gtk_container_add(GTK_CONTAINER(localvbox), localbutton);
...
void ProjectCallback(GtkWidget *widget, gpointer *data) {
  ...
  default:
    ...
    case 0:
      PgamTwodProjectSqr(addlower, addupper, subtractlower, subtractupper, desthist, add,
                         projectsqraxis);
      break;
    case 3:
