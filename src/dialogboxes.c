...
void RetainSpectraEntry(GtkWidget *widget,
                     GtkWidget *entry);
...
void AddSpectraEntry(GtkWidget *widget,
                     GtkWidget *entry);
void AddSpectraPrompt(GtkWidget *text);
void SubtractSpectraEntry(GtkWidget *widget,
                     GtkWidget *entry);
void SubtractSpectraPrompt(GtkWidget *text);
void MoveSpectraEntry(GtkWidget *widget,
                     GtkWidget *entry);
void MoveSpectraPrompt(GtkWidget *text);
void NormalizeSpectraEntry(GtkWidget *widget,
                     GtkWidget *entry);
void NormalizeSpectraPrompt(GtkWidget *text);
void CompressSpectraEntry(GtkWidget *widget,
                     GtkWidget *entry);
void CompressSpectraPrompt(GtkWidget *text);
void ClearSpectraEntry(GtkWidget *widget,
                     GtkWidget *entry);
void ClearSpectraPrompt(GtkWidget *text);
void TitleSpectraEntry(GtkWidget *widget,
                     GtkWidget *entry);
void TitleSpectraPrompt(GtkWidget *text);
void GainshiftSpectraEntry(GtkWidget *widget,
                     GtkWidget *entry);
void GainshiftSpectraPrompt(GtkWidget *text);
void FixedWidthGaussFitEntry(GtkWidget *widget,
                     GtkWidget *entry);
void FixedWidthGaussFitPrompt(GtkWidget *text);
void GainshiftSpectraPrompt(GtkWidget *text);
void DoubleGaussFitEntry(GtkWidget *widget,
                     GtkWidget *entry);
...
void ManualSetBackgroundEntry(GtkWidget *widget,
                     GtkWidget *entry);
void ManualSetBackgroundPrompt(GtkWidget *text);
void RetainSpectraEntry(GtkWidget *widget,
                     GtkWidget *entry);
void RetainSpectraPrompt(GtkWidget *text);
void WriteFileEntry(GtkWidget *widget,
                     GtkWidget *entry);
...
void GetMessageDialog (const char *message)
{
  ...
  if (!modalwindowopen) {
    ...
    g_signal_connect (GTK_OBJECT(dialog),"delete_event",
			G_CALLBACK(CloseModalWidget),NULL);
    //--ddc aug11    gtk_signal_connect (GTK_OBJECT(dialog),"destroy",
    g_signal_connect (GTK_OBJECT(dialog),"destroy",
			G_CALLBACK(CloseModalWidget),dialog);
  /* --- make the ok button --- */
    ...
    g_signal_connect_swapped(GTK_OBJECT(ok_button),"clicked",
			    G_CALLBACK(CloseModalWidget),(GtkObject *) dialog);
...
void GetDialog (int type)
{
  ...
  g_signal_connect_swapped(GTK_OBJECT(cancel_button),"clicked",
			    G_CALLBACK(CloseWidgetCancel),(GtkObject *)dialog);
  ...
  text = gtk_text_view_new();
  //  gtk_text_set_editable(GTK_TEXT(text),FALSE);
  gtk_box_pack_start(GTK_BOX (textbox),text,
  ...
  case 1:
    ...
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(MultipleDisplayEntry),entry);
  ...
  case 2:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(RetainSpectraEntry),entry);
  ...
  case 3:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(ManualMarkerEntry),entry);
  ...
  case 4:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(ExpandPlotEntry),entry);
  ...
  case 5:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(SetYScaleEntry),entry);
  ...
  case 6:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(MultipleDisplaySameRangeEntry),entry);
    MultipleDisplayPrompt(text);
    break;
  case 7:
    /* --- case of add spectra  --- */
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(AddSpectraEntry),entry);
  ...
  case 8:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(SubtractSpectraEntry),entry);
  ...
  case 9:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(MoveSpectraEntry),entry);
  ...
  case 10:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(NormalizeSpectraEntry),entry);
  ...
  case 11:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(CompressSpectraEntry),entry);
  ...
  case 12:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(ClearSpectraEntry),entry);
  ...
  case 13:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(TitleSpectraEntry),entry);
  ...
  case 14:
    ...
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(GainshiftSpectraEntry),entry);
  ...
  case 15:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(FixedWidthGaussFitEntry),entry);
  ...
  case 16:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(DoubleGaussFitEntry),entry);
  ...
  case 17:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(GetCalibrationEntry),entry);
  ...
  case 18:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(ManualSetBackgroundEntry),entry);
  ...
  case 19:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(SortTypeEntry),entry);
    SortTypePrompt(text);
    break;
  case 20:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(ChannelsEntry),entry);
    ChannelsPrompt(text);
    break;
  case 21:
  ...
  case 22:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(DopplerCorrectionEntry),entry);
  ...
  case 23:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(TwdorSqrEntry),entry);
    TwdorSqrPrompt(text);
    break;
  case 24:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(WriteFileEntry),entry);
  ...
  case 25:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
			G_CALLBACK(SetEfficiencyEntry),entry);
  ...
  case 26:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(SpawnPrintEntry),entry);
  ...
  case 28:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(WriteBigEntry),entry);
    WriteBigPrompt(text);
    break;
  case 30:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(MultiInOneEntry),entry);
  ...
  case 31:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(NumContoursEntry),entry);
  ...
  case 32:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(PgamSpawnPrintEntry),entry);
    SpawnPrintPrompt(text);
    break;
  case 33:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(PgamSetTwodTitleEntry),entry);
  ...
  case 34:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(PgamDisplaySelectionEntry),entry);
  ...
  case 35:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(PgamClear2DEntry),entry);
  ...
  case 36:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(PgamAdd2DEntry),entry);
  ...
  case 37:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(PgamSubtract2DEntry),entry);
  ...
  case 38:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(XCalibrationEntry),entry);
  ...
  case 39:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(YCalibrationEntry),entry);
  ...
  case 50:
    ...
    //--ddc aug11    gtk_signal_connect(GTK_OBJECT(entry),"activate",
    g_signal_connect(GTK_OBJECT(entry),"activate",
		       G_CALLBACK(FindPeaksEntry),entry);
  ...
  g_signal_connect_swapped(GTK_OBJECT(entry),"activate",
			    G_CALLBACK(CloseWidget),(GtkObject *)dialog);
